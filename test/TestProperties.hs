...
propertiesTests = testGroup "Delphi Property Tests"
  [ testCase "property Items[I: Integer]: T read GetItem" $
    (Right (Property "Items" (Just [Arg NormalArg "I" (Type "Integer") Nothing]) (Type "T") Nothing [PropertyRead "GetItem"] False) @=? )$
    parse property' "" "property Items[I: Integer]: T read GetItem;"
  , testCase "property Items[I: Integer]: T<E> read GetItem" $
    (Right (Property "Items" (Just [Arg NormalArg "I" (Type "Integer") Nothing]) (GenericInstance "T" [Type "E"]) Nothing [PropertyRead "GetItem"] True) @=? )$
